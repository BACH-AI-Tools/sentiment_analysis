...
# 服务器版本和配置
__version__ = "1.0.0"
__tag__ = "sentiment_analysis/1.0.0"
...
# OpenAPI 规范
OPENAPI_SPEC = """{\n  \"openapi\": \"3.0.0\",\n  \"info\": {\n    \"title\": \"Sentiment Analysis\",\n    \"version\": \"1.0.0\",\n    \"description\": \"RapidAPI: twinword/sentiment-analysis\"\n  },\n  \"servers\": [\n    {\n      \"url\": \"https://sentiment-analysis.p.rapidapi.com\"\n    }\n  ],\n  \"paths\": {\n    \"/endpoint\": {\n      \"get\": {\n        \"summary\": \"API Endpoint\",\n        \"description\": \"请根据 RapidAPI 页面手动添加端点信息\",\n        \"operationId\": \"api_endpoint\",\n        \"parameters\": [\n          {\n            \"name\": \"param\",\n            \"in\": \"query\",\n            \"required\": false,\n            \"description\": \"参数\",\n            \"schema\": {\n              \"type\": \"string\",\n              \"default\": null,\n              \"enum\": null\n            }\n          }\n        ],\n        \"responses\": {\n          \"200\": {\n            \"description\": \"Success\"\n          }\n        }\n      }\n    }\n  },\n  \"components\": {\n    \"securitySchemes\": {\n      \"ApiAuth\": {\n        \"type\": \"apiKey\",\n        \"in\": \"header\",\n        \"name\": \"X-RapidAPI-Key\"\n      }\n    }\n  },\n  \"security\": [\n    {\n      \"ApiAuth\": []\n    }\n  ]\n}"""
...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "sentiment-analysis.p.rapidapi.com"
else:
...
client = httpx.AsyncClient(
    base_url="https://sentiment-analysis.p.rapidapi.com", 
    timeout=30.0
)
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "sentiment-analysis.p.rapidapi.com"
    else:
...
def main():
    """主入口点"""
    print(f"🚀 启动 Sentiment Analysis MCP 服务器")
    print(f"📦 版本: {__tag__}")
